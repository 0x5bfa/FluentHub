...
FluentHub thrives off of the contributions and input from users. There are several ways you can get involved.

We are happy to hear your feedback for the future of FluentHub. Check the
...
We welcome your contributions to the FluentHub project, especially to fix bugs and to make
improvements which address the top issues reported by FluentHub users. Some general guidelines:
...
## Review Process
After submitting a pull request, members of the FluentHub team will review your code. We will
assign the request to an appropriate reviewer. Any member of the community may
participate in the review, but at least one member of the FluentHub team will ultimately approve
the request.
