...
namespace FluentHub.Features.Organizations.ViewModels
{
	public class RepositoriesViewModel : BaseViewModel
	{
		...
		public RepositoriesViewModel(IFluentHubGitHubClient gitHub, ScreenViewModelDependencies dependencies) : base(gitHub, dependencies)
		{
			_repositories = new();
