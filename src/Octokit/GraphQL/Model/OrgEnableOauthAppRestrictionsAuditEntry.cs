namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgEnableOauthAppRestrictionsAuditEntry : QueryableValue<OrgEnableOauthAppRestrictionsAuditEntry>
    {
        internal OrgEnableOauthAppRestrictionsAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgEnableOauthAppRestrictionsAuditEntry Create(Expression expression)
        {
            return new OrgEnableOauthAppRestrictionsAuditEntry(expression);
        }
    }
}