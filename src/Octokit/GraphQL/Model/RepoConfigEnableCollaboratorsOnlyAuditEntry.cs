namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigEnableCollaboratorsOnlyAuditEntry : QueryableValue<RepoConfigEnableCollaboratorsOnlyAuditEntry>
    {
        internal RepoConfigEnableCollaboratorsOnlyAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigEnableCollaboratorsOnlyAuditEntry Create(Expression expression)
        {
            return new RepoConfigEnableCollaboratorsOnlyAuditEntry(expression);
        }
    }
}