namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoCreateAuditEntry : QueryableValue<RepoCreateAuditEntry>
    {
        internal RepoCreateAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public RepoCreateAuditEntryVisibility? Visibility { get; }

        internal static RepoCreateAuditEntry Create(Expression expression)
        {
            return new RepoCreateAuditEntry(expression);
        }
    }
}