namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgAddBillingManagerAuditEntry : QueryableValue<OrgAddBillingManagerAuditEntry>
    {
        internal OrgAddBillingManagerAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public string InvitationEmail { get; }
        ...
        internal static OrgAddBillingManagerAuditEntry Create(Expression expression)
        {
            return new OrgAddBillingManagerAuditEntry(expression);
        }
    }
}