namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoAddTopicAuditEntry : QueryableValue<RepoAddTopicAuditEntry>
    {
        internal RepoAddTopicAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoAddTopicAuditEntry Create(Expression expression)
        {
            return new RepoAddTopicAuditEntry(expression);
        }
    }
}