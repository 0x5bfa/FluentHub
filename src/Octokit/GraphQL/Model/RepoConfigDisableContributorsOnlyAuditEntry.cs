namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigDisableContributorsOnlyAuditEntry : QueryableValue<RepoConfigDisableContributorsOnlyAuditEntry>
    {
        internal RepoConfigDisableContributorsOnlyAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigDisableContributorsOnlyAuditEntry Create(Expression expression)
        {
            return new RepoConfigDisableContributorsOnlyAuditEntry(expression);
        }
    }
}