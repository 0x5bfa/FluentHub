namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoChangeMergeSettingAuditEntry : QueryableValue<RepoChangeMergeSettingAuditEntry>
    {
        internal RepoChangeMergeSettingAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public RepoChangeMergeSettingAuditEntryMergeType? MergeType { get; }
        ...
        internal static RepoChangeMergeSettingAuditEntry Create(Expression expression)
        {
            return new RepoChangeMergeSettingAuditEntry(expression);
        }
    }
}