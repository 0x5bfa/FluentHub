namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgRemoveMemberAuditEntry : QueryableValue<OrgRemoveMemberAuditEntry>
    {
        internal OrgRemoveMemberAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public IEnumerable<OrgRemoveMemberAuditEntryMembershipType> MembershipTypes { get; }
        ...
        /// </summary>
        public OrgRemoveMemberAuditEntryReason? Reason { get; }
        ...
        internal static OrgRemoveMemberAuditEntry Create(Expression expression)
        {
            return new OrgRemoveMemberAuditEntry(expression);
        }
    }
}