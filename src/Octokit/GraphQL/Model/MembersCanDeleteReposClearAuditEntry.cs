namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class MembersCanDeleteReposClearAuditEntry : QueryableValue<MembersCanDeleteReposClearAuditEntry>
    {
        internal MembersCanDeleteReposClearAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static MembersCanDeleteReposClearAuditEntry Create(Expression expression)
        {
            return new MembersCanDeleteReposClearAuditEntry(expression);
        }
    }
}