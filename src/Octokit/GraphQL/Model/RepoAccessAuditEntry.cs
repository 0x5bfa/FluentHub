namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoAccessAuditEntry : QueryableValue<RepoAccessAuditEntry>
    {
        internal RepoAccessAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public RepoAccessAuditEntryVisibility? Visibility { get; }

        internal static RepoAccessAuditEntry Create(Expression expression)
        {
            return new RepoAccessAuditEntry(expression);
        }
    }
}