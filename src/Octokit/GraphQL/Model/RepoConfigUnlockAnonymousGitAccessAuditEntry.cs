namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigUnlockAnonymousGitAccessAuditEntry : QueryableValue<RepoConfigUnlockAnonymousGitAccessAuditEntry>
    {
        internal RepoConfigUnlockAnonymousGitAccessAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigUnlockAnonymousGitAccessAuditEntry Create(Expression expression)
        {
            return new RepoConfigUnlockAnonymousGitAccessAuditEntry(expression);
        }
    }
}