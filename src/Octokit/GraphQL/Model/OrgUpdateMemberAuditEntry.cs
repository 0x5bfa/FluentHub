namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgUpdateMemberAuditEntry : QueryableValue<OrgUpdateMemberAuditEntry>
    {
        internal OrgUpdateMemberAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public OrgUpdateMemberAuditEntryPermission? Permission { get; }

        /// <summary>
        /// The former member permission level for the organization.
        /// </summary>
        public OrgUpdateMemberAuditEntryPermission? PermissionWas { get; }
        ...
        internal static OrgUpdateMemberAuditEntry Create(Expression expression)
        {
            return new OrgUpdateMemberAuditEntry(expression);
        }
    }
}