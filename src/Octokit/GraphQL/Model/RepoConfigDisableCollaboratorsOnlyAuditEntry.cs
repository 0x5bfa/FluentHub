namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigDisableCollaboratorsOnlyAuditEntry : QueryableValue<RepoConfigDisableCollaboratorsOnlyAuditEntry>
    {
        internal RepoConfigDisableCollaboratorsOnlyAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigDisableCollaboratorsOnlyAuditEntry Create(Expression expression)
        {
            return new RepoConfigDisableCollaboratorsOnlyAuditEntry(expression);
        }
    }
}