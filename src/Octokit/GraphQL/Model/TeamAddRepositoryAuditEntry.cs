namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class TeamAddRepositoryAuditEntry : QueryableValue<TeamAddRepositoryAuditEntry>
    {
        internal TeamAddRepositoryAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static TeamAddRepositoryAuditEntry Create(Expression expression)
        {
            return new TeamAddRepositoryAuditEntry(expression);
        }
    }
}