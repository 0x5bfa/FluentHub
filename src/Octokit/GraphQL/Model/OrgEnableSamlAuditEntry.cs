namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgEnableSamlAuditEntry : QueryableValue<OrgEnableSamlAuditEntry>
    {
        internal OrgEnableSamlAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgEnableSamlAuditEntry Create(Expression expression)
        {
            return new OrgEnableSamlAuditEntry(expression);
        }
    }
}