namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigLockAnonymousGitAccessAuditEntry : QueryableValue<RepoConfigLockAnonymousGitAccessAuditEntry>
    {
        internal RepoConfigLockAnonymousGitAccessAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigLockAnonymousGitAccessAuditEntry Create(Expression expression)
        {
            return new RepoConfigLockAnonymousGitAccessAuditEntry(expression);
        }
    }
}