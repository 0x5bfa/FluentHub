namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgDisableTwoFactorRequirementAuditEntry : QueryableValue<OrgDisableTwoFactorRequirementAuditEntry>
    {
        internal OrgDisableTwoFactorRequirementAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgDisableTwoFactorRequirementAuditEntry Create(Expression expression)
        {
            return new OrgDisableTwoFactorRequirementAuditEntry(expression);
        }
    }
}