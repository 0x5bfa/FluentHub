namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgEnableTwoFactorRequirementAuditEntry : QueryableValue<OrgEnableTwoFactorRequirementAuditEntry>
    {
        internal OrgEnableTwoFactorRequirementAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgEnableTwoFactorRequirementAuditEntry Create(Expression expression)
        {
            return new OrgEnableTwoFactorRequirementAuditEntry(expression);
        }
    }
}