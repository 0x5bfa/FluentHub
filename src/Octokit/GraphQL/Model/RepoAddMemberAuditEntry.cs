namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoAddMemberAuditEntry : QueryableValue<RepoAddMemberAuditEntry>
    {
        internal RepoAddMemberAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public RepoAddMemberAuditEntryVisibility? Visibility { get; }

        internal static RepoAddMemberAuditEntry Create(Expression expression)
        {
            return new RepoAddMemberAuditEntry(expression);
        }
    }
}