namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgOauthAppAccessDeniedAuditEntry : QueryableValue<OrgOauthAppAccessDeniedAuditEntry>
    {
        internal OrgOauthAppAccessDeniedAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgOauthAppAccessDeniedAuditEntry Create(Expression expression)
        {
            return new OrgOauthAppAccessDeniedAuditEntry(expression);
        }
    }
}