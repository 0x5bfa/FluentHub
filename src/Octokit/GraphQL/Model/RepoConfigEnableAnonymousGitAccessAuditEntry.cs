namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigEnableAnonymousGitAccessAuditEntry : QueryableValue<RepoConfigEnableAnonymousGitAccessAuditEntry>
    {
        internal RepoConfigEnableAnonymousGitAccessAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigEnableAnonymousGitAccessAuditEntry Create(Expression expression)
        {
            return new RepoConfigEnableAnonymousGitAccessAuditEntry(expression);
        }
    }
}