namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepositoryVisibilityChangeDisableAuditEntry : QueryableValue<RepositoryVisibilityChangeDisableAuditEntry>
    {
        internal RepositoryVisibilityChangeDisableAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepositoryVisibilityChangeDisableAuditEntry Create(Expression expression)
        {
            return new RepositoryVisibilityChangeDisableAuditEntry(expression);
        }
    }
}