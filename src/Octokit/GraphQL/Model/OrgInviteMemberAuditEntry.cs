namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgInviteMemberAuditEntry : QueryableValue<OrgInviteMemberAuditEntry>
    {
        internal OrgInviteMemberAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgInviteMemberAuditEntry Create(Expression expression)
        {
            return new OrgInviteMemberAuditEntry(expression);
        }
    }
}