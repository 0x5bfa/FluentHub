namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgRemoveOutsideCollaboratorAuditEntry : QueryableValue<OrgRemoveOutsideCollaboratorAuditEntry>
    {
        internal OrgRemoveOutsideCollaboratorAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public IEnumerable<OrgRemoveOutsideCollaboratorAuditEntryMembershipType> MembershipTypes { get; }
        ...
        /// </summary>
        public OrgRemoveOutsideCollaboratorAuditEntryReason? Reason { get; }
        ...
        internal static OrgRemoveOutsideCollaboratorAuditEntry Create(Expression expression)
        {
            return new OrgRemoveOutsideCollaboratorAuditEntry(expression);
        }
    }
}