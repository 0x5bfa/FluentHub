namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgInviteToBusinessAuditEntry : QueryableValue<OrgInviteToBusinessAuditEntry>
    {
        internal OrgInviteToBusinessAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgInviteToBusinessAuditEntry Create(Expression expression)
        {
            return new OrgInviteToBusinessAuditEntry(expression);
        }
    }
}