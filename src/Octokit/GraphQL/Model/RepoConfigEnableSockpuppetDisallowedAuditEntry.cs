namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigEnableSockpuppetDisallowedAuditEntry : QueryableValue<RepoConfigEnableSockpuppetDisallowedAuditEntry>
    {
        internal RepoConfigEnableSockpuppetDisallowedAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigEnableSockpuppetDisallowedAuditEntry Create(Expression expression)
        {
            return new RepoConfigEnableSockpuppetDisallowedAuditEntry(expression);
        }
    }
}