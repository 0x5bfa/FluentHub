namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgDisableSamlAuditEntry : QueryableValue<OrgDisableSamlAuditEntry>
    {
        internal OrgDisableSamlAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public string SignatureMethodUrl { get; }
        ...
        internal static OrgDisableSamlAuditEntry Create(Expression expression)
        {
            return new OrgDisableSamlAuditEntry(expression);
        }
    }
}