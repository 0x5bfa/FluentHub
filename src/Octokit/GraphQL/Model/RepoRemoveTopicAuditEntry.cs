namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoRemoveTopicAuditEntry : QueryableValue<RepoRemoveTopicAuditEntry>
    {
        internal RepoRemoveTopicAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoRemoveTopicAuditEntry Create(Expression expression)
        {
            return new RepoRemoveTopicAuditEntry(expression);
        }
    }
}