namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgUpdateMemberRepositoryCreationPermissionAuditEntry : QueryableValue<OrgUpdateMemberRepositoryCreationPermissionAuditEntry>
    {
        internal OrgUpdateMemberRepositoryCreationPermissionAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public bool? CanCreateRepositories { get; }
        ...
        /// </summary>
        public OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility? Visibility { get; }

        internal static OrgUpdateMemberRepositoryCreationPermissionAuditEntry Create(Expression expression)
        {
            return new OrgUpdateMemberRepositoryCreationPermissionAuditEntry(expression);
        }
    }
}