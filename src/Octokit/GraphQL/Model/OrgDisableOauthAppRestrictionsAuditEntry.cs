namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgDisableOauthAppRestrictionsAuditEntry : QueryableValue<OrgDisableOauthAppRestrictionsAuditEntry>
    {
        internal OrgDisableOauthAppRestrictionsAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgDisableOauthAppRestrictionsAuditEntry Create(Expression expression)
        {
            return new OrgDisableOauthAppRestrictionsAuditEntry(expression);
        }
    }
}