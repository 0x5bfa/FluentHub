namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgOauthAppAccessApprovedAuditEntry : QueryableValue<OrgOauthAppAccessApprovedAuditEntry>
    {
        internal OrgOauthAppAccessApprovedAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgOauthAppAccessApprovedAuditEntry Create(Expression expression)
        {
            return new OrgOauthAppAccessApprovedAuditEntry(expression);
        }
    }
}