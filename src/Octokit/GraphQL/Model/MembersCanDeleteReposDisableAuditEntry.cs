namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class MembersCanDeleteReposDisableAuditEntry : QueryableValue<MembersCanDeleteReposDisableAuditEntry>
    {
        internal MembersCanDeleteReposDisableAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static MembersCanDeleteReposDisableAuditEntry Create(Expression expression)
        {
            return new MembersCanDeleteReposDisableAuditEntry(expression);
        }
    }
}