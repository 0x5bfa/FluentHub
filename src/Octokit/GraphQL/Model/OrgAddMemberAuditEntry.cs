namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgAddMemberAuditEntry : QueryableValue<OrgAddMemberAuditEntry>
    {
        internal OrgAddMemberAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public OrgAddMemberAuditEntryPermission? Permission { get; }
        ...
        internal static OrgAddMemberAuditEntry Create(Expression expression)
        {
            return new OrgAddMemberAuditEntry(expression);
        }
    }
}