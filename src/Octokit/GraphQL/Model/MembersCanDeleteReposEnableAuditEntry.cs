namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class MembersCanDeleteReposEnableAuditEntry : QueryableValue<MembersCanDeleteReposEnableAuditEntry>
    {
        internal MembersCanDeleteReposEnableAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static MembersCanDeleteReposEnableAuditEntry Create(Expression expression)
        {
            return new MembersCanDeleteReposEnableAuditEntry(expression);
        }
    }
}