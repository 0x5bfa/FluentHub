namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoRemoveMemberAuditEntry : QueryableValue<RepoRemoveMemberAuditEntry>
    {
        internal RepoRemoveMemberAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public RepoRemoveMemberAuditEntryVisibility? Visibility { get; }

        internal static RepoRemoveMemberAuditEntry Create(Expression expression)
        {
            return new RepoRemoveMemberAuditEntry(expression);
        }
    }
}