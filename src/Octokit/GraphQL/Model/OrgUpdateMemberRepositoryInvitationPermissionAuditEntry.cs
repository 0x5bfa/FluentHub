namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgUpdateMemberRepositoryInvitationPermissionAuditEntry : QueryableValue<OrgUpdateMemberRepositoryInvitationPermissionAuditEntry>
    {
        internal OrgUpdateMemberRepositoryInvitationPermissionAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public bool? CanInviteOutsideCollaboratorsToRepositories { get; }
        ...
        internal static OrgUpdateMemberRepositoryInvitationPermissionAuditEntry Create(Expression expression)
        {
            return new OrgUpdateMemberRepositoryInvitationPermissionAuditEntry(expression);
        }
    }
}