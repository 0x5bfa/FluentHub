namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgUpdateDefaultRepositoryPermissionAuditEntry : QueryableValue<OrgUpdateDefaultRepositoryPermissionAuditEntry>
    {
        internal OrgUpdateDefaultRepositoryPermissionAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgUpdateDefaultRepositoryPermissionAuditEntry Create(Expression expression)
        {
            return new OrgUpdateDefaultRepositoryPermissionAuditEntry(expression);
        }
    }
}