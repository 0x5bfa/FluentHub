namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigDisableAnonymousGitAccessAuditEntry : QueryableValue<RepoConfigDisableAnonymousGitAccessAuditEntry>
    {
        internal RepoConfigDisableAnonymousGitAccessAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigDisableAnonymousGitAccessAuditEntry Create(Expression expression)
        {
            return new RepoConfigDisableAnonymousGitAccessAuditEntry(expression);
        }
    }
}