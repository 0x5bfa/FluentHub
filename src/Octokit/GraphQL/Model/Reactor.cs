namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class Reactor : QueryableValue<Reactor>, IUnion
    {
        internal Reactor(Expression expression) : base(expression)
        {
        }
        ...
        internal static Reactor Create(Expression expression)
        {
