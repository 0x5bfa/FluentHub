namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class PrivateRepositoryForkingDisableAuditEntry : QueryableValue<PrivateRepositoryForkingDisableAuditEntry>
    {
        internal PrivateRepositoryForkingDisableAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static PrivateRepositoryForkingDisableAuditEntry Create(Expression expression)
        {
            return new PrivateRepositoryForkingDisableAuditEntry(expression);
        }
    }
}