namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoDestroyAuditEntry : QueryableValue<RepoDestroyAuditEntry>
    {
        internal RepoDestroyAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public RepoDestroyAuditEntryVisibility? Visibility { get; }

        internal static RepoDestroyAuditEntry Create(Expression expression)
        {
            return new RepoDestroyAuditEntry(expression);
        }
    }
}