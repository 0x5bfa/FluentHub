namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgConfigDisableCollaboratorsOnlyAuditEntry : QueryableValue<OrgConfigDisableCollaboratorsOnlyAuditEntry>
    {
        internal OrgConfigDisableCollaboratorsOnlyAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgConfigDisableCollaboratorsOnlyAuditEntry Create(Expression expression)
        {
            return new OrgConfigDisableCollaboratorsOnlyAuditEntry(expression);
        }
    }
}