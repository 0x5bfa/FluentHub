namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigDisableSockpuppetDisallowedAuditEntry : QueryableValue<RepoConfigDisableSockpuppetDisallowedAuditEntry>
    {
        internal RepoConfigDisableSockpuppetDisallowedAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigDisableSockpuppetDisallowedAuditEntry Create(Expression expression)
        {
            return new RepoConfigDisableSockpuppetDisallowedAuditEntry(expression);
        }
    }
}