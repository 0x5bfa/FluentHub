namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgBlockUserAuditEntry : QueryableValue<OrgBlockUserAuditEntry>
    {
        internal OrgBlockUserAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgBlockUserAuditEntry Create(Expression expression)
        {
            return new OrgBlockUserAuditEntry(expression);
        }
    }
}