namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoConfigEnableContributorsOnlyAuditEntry : QueryableValue<RepoConfigEnableContributorsOnlyAuditEntry>
    {
        internal RepoConfigEnableContributorsOnlyAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static RepoConfigEnableContributorsOnlyAuditEntry Create(Expression expression)
        {
            return new RepoConfigEnableContributorsOnlyAuditEntry(expression);
        }
    }
}