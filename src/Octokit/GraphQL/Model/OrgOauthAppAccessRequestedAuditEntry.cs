namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgOauthAppAccessRequestedAuditEntry : QueryableValue<OrgOauthAppAccessRequestedAuditEntry>
    {
        internal OrgOauthAppAccessRequestedAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgOauthAppAccessRequestedAuditEntry Create(Expression expression)
        {
            return new OrgOauthAppAccessRequestedAuditEntry(expression);
        }
    }
}