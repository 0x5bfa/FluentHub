namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgUnblockUserAuditEntry : QueryableValue<OrgUnblockUserAuditEntry>
    {
        internal OrgUnblockUserAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public User BlockedUser => this.CreateProperty(x => x.BlockedUser, Octokit.GraphQL.Model.User.Create);

        /// <summary>
        /// The username of the blocked user.
        /// </summary>
        public string BlockedUserName { get; }

        /// <summary>
        /// The HTTP path for the blocked user.
        /// </summary>
        public string BlockedUserResourcePath { get; }

        /// <summary>
        /// The HTTP URL for the blocked user.
        /// </summary>
        public string BlockedUserUrl { get; }
        ...
        internal static OrgUnblockUserAuditEntry Create(Expression expression)
        {
            return new OrgUnblockUserAuditEntry(expression);
        }
    }
}