namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class TeamAddMemberAuditEntry : QueryableValue<TeamAddMemberAuditEntry>
    {
        internal TeamAddMemberAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static TeamAddMemberAuditEntry Create(Expression expression)
        {
            return new TeamAddMemberAuditEntry(expression);
        }
    }
}