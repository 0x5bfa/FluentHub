namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgConfigEnableCollaboratorsOnlyAuditEntry : QueryableValue<OrgConfigEnableCollaboratorsOnlyAuditEntry>
    {
        internal OrgConfigEnableCollaboratorsOnlyAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgConfigEnableCollaboratorsOnlyAuditEntry Create(Expression expression)
        {
            return new OrgConfigEnableCollaboratorsOnlyAuditEntry(expression);
        }
    }
}