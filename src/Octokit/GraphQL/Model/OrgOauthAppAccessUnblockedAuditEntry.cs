namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class OrgOauthAppAccessUnblockedAuditEntry : QueryableValue<OrgOauthAppAccessUnblockedAuditEntry>
    {
        internal OrgOauthAppAccessUnblockedAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        internal static OrgOauthAppAccessUnblockedAuditEntry Create(Expression expression)
        {
            return new OrgOauthAppAccessUnblockedAuditEntry(expression);
        }
    }
}