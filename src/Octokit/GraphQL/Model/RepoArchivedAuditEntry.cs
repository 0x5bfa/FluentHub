namespace Octokit.GraphQL.Model
{
    ...
    /// </summary>
    public class RepoArchivedAuditEntry : QueryableValue<RepoArchivedAuditEntry>
    {
        internal RepoArchivedAuditEntry(Expression expression) : base(expression)
        {
        }
        ...
        /// </summary>
        public RepoArchivedAuditEntryVisibility? Visibility { get; }

        internal static RepoArchivedAuditEntry Create(Expression expression)
        {
            return new RepoArchivedAuditEntry(expression);
        }
    }
}