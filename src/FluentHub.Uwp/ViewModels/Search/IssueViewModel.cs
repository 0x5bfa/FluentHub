...
namespace FluentHub.Uwp.ViewModels.Search
{
    public class IssueViewModel : ObservableObject
    {
        ...
        private readonly ObservableCollection<SearchIssueButtonBlockViewModel> _results;
        public ReadOnlyObservableCollection<SearchIssueButtonBlockViewModel> ResultItems { get; }
        ...
        private async Task LoadSearchResultsAsync(String query)
        {
            ...
            IssueSearchQueries queries = new();
            ...
            {
                SearchIssueButtonBlockViewModel viewmodel = new()
                {
                    Item = item,
                };
        ...
        private void SetCurrentTabItem()
        {
            ...
            currentItem.Url = "fluenthub://search/issue/" + query.Replace(" ", "&");
            currentItem.DisplayUrl = $"Search / Issue / " + query;
