...
namespace FluentHub.Octokit.Models.v4
{
	...
	/// </summary>
	public class OrgRemoveOutsideCollaboratorAuditEntry
	{
		/// <summary>
		/// The action name
		/// </summary>
		...
		/// </summary>
		public List<OrgRemoveOutsideCollaboratorAuditEntryMembershipType> MembershipTypes { get; set; }
		...
		/// </summary>
		public OrgRemoveOutsideCollaboratorAuditEntryReason? Reason { get; set; }
