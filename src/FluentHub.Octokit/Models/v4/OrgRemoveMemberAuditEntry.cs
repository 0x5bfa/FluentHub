...
namespace FluentHub.Octokit.Models.v4
{
	...
	/// </summary>
	public class OrgRemoveMemberAuditEntry
	{
		/// <summary>
		/// The action name
		/// </summary>
		...
		/// </summary>
		public List<OrgRemoveMemberAuditEntryMembershipType> MembershipTypes { get; set; }
		...
		/// </summary>
		public OrgRemoveMemberAuditEntryReason? Reason { get; set; }
