...
namespace FluentHub.Octokit.Models.v4
{
	...
	/// </summary>
	public class OrgUpdateMemberAuditEntry
	{
		/// <summary>
		/// The action name
		/// </summary>
		...
		/// </summary>
		public OrgUpdateMemberAuditEntryPermission? Permission { get; set; }

		/// <summary>
		/// The former member permission level for the organization.
		/// </summary>
		public OrgUpdateMemberAuditEntryPermission? PermissionWas { get; set; }
